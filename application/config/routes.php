...
$route['admin/getemployeelist'] = 'admin/getEmployeeList';
$route['admin/addnew'] = 'admin/addNew';
$route['admin/savenew'] = 'admin/saveNew';
$route['admin/editemp/(:any)'] = 'admin/editEmp/$1';
$route['admin/updateemployee'] = 'admin/updateEmployee';
$route['admin/deleteemployee'] = 'admin/DeleteEmployee';
